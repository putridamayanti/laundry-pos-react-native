                ...
                <Content style={styles.content}>
                    <Grid>
                        <Col style={{marginRight: 10}}>
                            <Button block style={{backgroundColor: Color.pink, height: 80}} onPress={() => this.props.navigation.navigate('FormTransaction')}>
                                <Text style={styles.textCenter}>Tambah Transaksi</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button block style={{backgroundColor: Color.dark, height: 80}}>
                                <Text style={styles.textCenter}>Daftar Transaksi</Text>
                            </Button>
                        </Col>
                    </Grid>
